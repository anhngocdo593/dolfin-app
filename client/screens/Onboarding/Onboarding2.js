    ...
    <ImageBackground source={require("../../assets/bg.png")}>
      <View className="w-screen h-full flex justify-center align-items items-center">
        ...
        <Text className="w-full px-10 text-xl py-2 text-[#519DD5] mb-5">
          Sử dụng tính năng kiểm soát ngân sách {"\n"} trong vòng 5 phút
        </Text>
        <View className="flex flex-row w-screen justify-between px-10 pt-10 mb-0">
          <View className="flex flex-row justify-center align-items items-center">
            <View
              className="w-[5] h-[5] bg-blue-300 mx-1"
              onPress={back}
            ></View>
          ...
          <TouchableOpacity onPress={handlePress}>
            <View className="bg-[#519DD5] rounded-2xl">
              <Text className="p-4 text-white text-xl">Tiếp theo</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
